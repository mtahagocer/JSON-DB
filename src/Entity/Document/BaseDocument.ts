...
export default class BaseDocument {
    ...
    static Save = async (UserId: string, CollectionName: string, Document: BaseDocument) => {
    ...
    static Update = async (UserId: string, CollectionName: string, Document, Replace: boolean) => {
